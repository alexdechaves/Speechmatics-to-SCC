...
def parse_args():
    ...
    parser = ArgumentParser(
        description='Processes a job through the Speechmatics to SCC',
    ...
    parser.add_argument('-k', '--token', type=str, required=True,
                        help="Your Speechmatics to SCC Authentication Token")
...
def main():
    ...
    if opts.output:
        with codecs.open(opts.output, 'w', 'utf-8') as ouf:
